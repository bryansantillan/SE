...
//*******************************************************************
static uint32_t UniversalTimeRefY2K; 		/** \brief Universal Time Reference in seconds from 1/1/2000 */
static uint32_t MonotonicClockSecondsRef;	/** \brief Reference of the monotonic clock in seconds*/
static uint32_t MonotonicClockSeconds; 		/** \brief Monotonic clock in seconds*/
static uint32_t TickCounter; 				/** \brief TickCounter*/
